...
const Card = ({ _id, thumbnail, title, owner, channel_owner, video_public_id }) => {
    ...
    return (
        <div className=" w-80 rounded-lg overflow-hidden shadow-lg bg-white dark:bg-gray-800 dark:text-gray-200 border border-gray-300 dark:border-gray-700 min-w-80 min-h-72">
