    ...
    return (
        ...
        <div className="w-full max-w-lg mx-auto p-4 bg-gray-100 rounded-md shadow-md relative">
            <div className='flex justify-between h-auto mb-4'>
                <h2 className="text-2xl font-semibold text-center">Update Video Details</h2>
                <div className=' border-black border-solid border-2 bg-red-600 text-black px-2' onClick={() => setUpdateVideo(false)}>X</div>
            </div>
